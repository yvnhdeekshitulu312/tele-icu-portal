...
@Component({
    selector: 'app-physiotherapy-appointments-worklist',
    templateUrl: './physiotherapy-appointments-worklist.component.html',
    providers: [
        {
            provide: DateAdapter,
...
export class PhysiotherapyAppointmentsWorklistComponent extends BaseComponent implements OnInit {
    cancelall = false;
    datesForm: any;
    ...
    FetchPatientAppointmentsWorkList() {
        ...
        const url = this.us.getApiUrl(futureAppointments.FetchPatientAppointmentsWorkListPhy, params);
...
export const futureAppointments = {
    FetchPatientAppointmentsWorkListPhy: 'FetchPatientAppointmentsWorkListPhy?FromDate=${FromDate}&ToDate=${ToDate}&SSN=${SSN}&DoctorID=${DoctorID}&UserId=${UserId}&WorkStationID=${WorkStationID}&HospitalID=${HospitalID}',
