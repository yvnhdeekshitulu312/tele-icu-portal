...
@Component({
  selector: 'app-electronic-respiratory',
  templateUrl: './electronic-respiratory.component.html',
  styleUrls: ['./electronic-respiratory.component.scss'],
  providers: [
      {
        provide: DateAdapter,
...
export class ElectronicRespiratoryComponent extends DynamicHtmlComponent implements OnInit {
