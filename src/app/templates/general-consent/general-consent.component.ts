...
@Component({
  selector: 'app-general-consent',
  templateUrl: './general-consent.component.html',
  styleUrls: ['./general-consent.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class GeneralConsentComponent extends DynamicHtmlComponent implements OnInit {
  @ViewChild('divgnct') divgnct!: ElementRef;
      ...
      .subscribe((response: any) => {
        if (response.Code == 200) {
          if (response.FetchPatienClinicalTemplateDetailsNNList.length > 0) {
            ...
            this.dataChangesMap = {};
            this.showElementsData(this.divgnct.nativeElement, JSON.parse(tem.ClinicalTemplateValues), sameUser, tem);
  ...
  save() {
    const tags = this.findHtmlTagIds(this.divgnct);
  ...
  ngAfterViewInit() {
    ...
    setTimeout(()=>{
      this.showdefault(this.divgnct.nativeElement);
    }, 4000); 
  }
