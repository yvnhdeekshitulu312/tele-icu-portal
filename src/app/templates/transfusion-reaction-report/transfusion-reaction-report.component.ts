...
declare var $: any;
@Component({
    selector: 'app-transfusion-reaction-report',
    templateUrl: './transfusion-reaction-report.component.html',
    providers: [
        {
            provide: DateAdapter,
...
export class TransfusionReactionReportComponent extends DynamicHtmlComponent implements OnInit, AfterViewInit {
    @ViewChild('divtrr') divtrr!: ElementRef;
    url = "";
    selectedView: any;
    doctorDetails: any;
    ...
    ngOnInit(): void {
        this.getreoperative("140");
    }

    ngAfterViewInit() {
        setTimeout(() => {
            this.showdefault(this.divtrr.nativeElement);
        }, 3000);
        this.bindTextboxValue('reactiondate', moment().format('DD-MMM-YYYY'));
        this.bindTextboxValue('Transfusionstart', moment().format('DD-MMM-YYYY'));
        this.bindTextboxValue('Transfusiondiscontinue', moment().format('DD-MMM-YYYY'));
        this.bindTextboxValue('vitalsDate', moment().format('DD-MMM-YYYY'));
        this.bindTextboxValue('techdate', moment().format('DD-MMM-YYYY'));
            ...
            .subscribe((response: any) => {
                if (response.Code == 200) {
                    if (response.FetchPatienClinicalTemplateDetailsNNList.length > 0) {
                        ...
                        this.dataChangesMap = {};
                        this.showElementsData(this.divtrr.nativeElement, JSON.parse(tem.ClinicalTemplateValues), sameUser, tem);
    ...
    save(bloodorderID: any) {
        const tags = this.findHtmlTagIds(this.divtrr);
        ...
        if (tags) {
            ...
            var payload = {
                ...
                "AssessmentOrderId": bloodorderID
            }
