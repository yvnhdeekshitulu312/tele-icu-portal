...
@Component({
  selector: 'app-office-of-medical-affairs',
  templateUrl: './office-of-medical-affairs.component.html',
  styleUrls: ['./office-of-medical-affairs.component.scss'],
  providers: [
    {
      provide: DateAdapter,
...
export class OfficeOfMedicalAffairsComponent extends DynamicHtmlComponent implements OnInit {

  @ViewChild('divooma') divooma!: ElementRef;
  url = "";
  selectedView: any;
  doctorDetails: any;
  ...
  ngOnInit(): void {
    this.getreoperative("69");
  }

  ngAfterViewInit() {
    setTimeout(()=>{
      this.showdefault(this.divooma.nativeElement);
    }, 1000);
      ...
      .subscribe((response: any) => {
        if (response.Code == 200) {
          if (response.FetchPatienClinicalTemplateDetailsNNList.length > 0) {
            ...
            this.showElementsData(this.divooma.nativeElement, JSON.parse(tem.ClinicalTemplateValues), sameUser, tem);
  ...
  save() {
    const tags = this.findHtmlTagIds(this.divooma);
