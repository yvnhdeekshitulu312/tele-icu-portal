...
export class EmergencyConfigService {
  ...
  FetchEMRPatientData(SSN: any, MobileNO: any, UserId: any, WorkStationID: any, HospitalID: any) {
   ...
   FetchEMRPatientDataUHID(SSN: any, MobileNO: any,UHID:any, UserId: any, WorkStationID: any, HospitalID: any) {
    return this.https.get<any>(this.devApiUrl + '/FetchEMRPatientDataUHID?SSN=' + SSN + '&MobileNO=' + MobileNO+ '&UHID=' + UHID + '&UserId=' + UserId + '&WorkStationID=' + WorkStationID + '&HospitalID=' + HospitalID + '', this.httpOptions);
  }
  FetchCheckInPatientC(SSN: any, WorkStationID: any, HospitalID: any) {
    return this.https.get<any>(this.devApiUrl + '/FetchCheckInPatientC?SSN=' + SSN + '&WorkStationID=' + WorkStationID + '&HospitalID=' + HospitalID + '', this.httpOptions);
  }
  ...
  FetchEMRConsultationOrdersSSN(FromDate: any, ToDate: any,SSN: any, UserId: any, WorkStationID: any, HospitalID: any, IsTriage: any) {
    return this.https.get<any>(this.devApiUrl + '/FetchEMRConsultationOrdersSSN?FromDate=' + FromDate + '&ToDate=' + ToDate+ '&SSN=' + SSN + '&UserId=' + UserId + '&WorkStationID=' + WorkStationID + '&HospitalID=' + HospitalID + '&IsTriage=' + IsTriage + '', this.httpOptions);
  }
  ...
  SavePatientDYCCTAS(payload: any) {
    return this.https.post<any>(this.devApiUrl + 'SavePatientDYCCTAS', payload, this.httpOptions);
  }
